...
export default function Dashboard(){
    ...
    return (
        <div>
            ...
            <p className="text-2xl ">Bienvenue {user?.firstname}</p>
            <button onClick={logout} className="underline border-2 rounded-full bg-danger text-black p-2">Se déconnecter</button>
           ...
           <div className='flex flex-col gap-8 p-4'>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <AddBook onBookAdded={() => {
                  // Cette fonction sera appelée quand un livre est ajouté
                }}/>
              </div>
              <div className="bg-white rounded-lg shadow p-6">
                <AvailableChart />
